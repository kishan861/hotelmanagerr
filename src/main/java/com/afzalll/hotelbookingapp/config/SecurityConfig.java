package com.afzalll.hotelbookingapp.config;

import com.afzalll.hotelbookingapp.security.CustomAuthenticationSuccessHandler;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorize) ->
                        authorize.requestMatchers("/css/**", "/js/**", "/webjars/**", "/img/**").permitAll()
                                ...
                                .requestMatchers("/search/**").hasRole("CUSTOMER")
